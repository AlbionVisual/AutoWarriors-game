 ...
 * @brief Начальные данные... данные будет не сложно вынести в json. Могут возникнуть
 * трудности только с добавлением своих новых эффектов и врагов
 *
 * Исопльзует пространство имён Enemy
 *
 * @date 2025-10-01
 *
 */
