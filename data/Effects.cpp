...
/**
 * @brief Функция-эффект соответствующая навыку "Скрытая атака" @see effect_func_type
 *
...
/**
 * @brief Функция-эффект соответствующая навыку "Порыв к действию" @see effect_func_type
 *
 * @return pawn_specifications - Изменения в характеристиках, но не сами характеристики!
 *
 */
...
/**
 * @brief Функция-эффект соответствующая навыку "Ярость" @see effect_func_type
 *
 * @return pawn_specifications - Изменения в характеристиках, но не сами характеристики!
 *
 */
...
/**
 * @brief Функция-эффект увеличивающая силу на единицу каждый бой @see effect_func_type
 *
 * @return pawn_specifications - Изменения в характеристиках, но не сами характеристики!
 *
 */
...
/**
 * @brief Функция-эффект увеличивающая ловкость на единицу каждый бой @see effect_func_type
 *
 * @return pawn_specifications - Изменения в характеристиках, но не сами характеристики!
 *
 */
...
/**
 * @brief Функция-эффект увеличивающая выносливость на единицу каждый бой @see effect_func_type
 *
 * @return pawn_specifications - Изменения в характеристиках, но не сами характеристики!
 *
 */
...
/**
 * @brief Функция-эффект соответствующая способности "яд" @see effect_func_type
 *
 * @return pawn_specifications - Изменения в характеристиках, но не сами характеристики!
 *
 */
...
/**
 * @brief Функция-эффект соответствующая навыку "Дыхание огнём" @see effect_func_type
 *
 * @return pawn_specifications - Изменения в характеристиках, но не сами характеристики!
 *
 */
...
/**
 * @brief Пустая функция-эффект для значений по умолчанию @see effect_func_type
 *
 * @return pawn_specifications(0, 0, 0)
 *
 */
