 ...
 * @brief Здесь описываются структура (описывающая само оружие), перечисление тегов
 *        (соответствующих каждому предопределённому оружию), а также констант для
 *        предопределённых оружий
 * @date 2025-10-03
 *
 */
