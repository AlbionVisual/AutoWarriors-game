 ...
 * @brief Здесь описываются класс отрисовщика окна, а также вспомогательной структуры Message
 *        для передачи сообщений на экран
 * @date 2025-10-01
 *
 */
 ...
 *        полностью стирает консоль (clear_console()) и перерисовывает всё заново.
 *
 */
class GameDrawer {
...
public:
    ...
    /**
     * @brief Пустой конструктор для инициализации полей. Объект не может использоваться в
     *        таком виде
     *
     */
    GameDrawer() {};
