...
/**
 * @brief Создание нового экземпляра класса GameDrawer
 *
 ...
 * #### Example:
 *
 * Используется только внутри GameDrawer::redraw_console()
 *
 */
 ...
 * #### Example:
 *
 * Используется только в Game::play_fight()
 *
 */
 ...
 * ```
 *
 * Используется только в GameDrawer::redraw_console()
 *
 */
 ...
 * #### Example:
 *
 * Обильно используется в main.cpp
 *
 */
 ...
 * #### Example:
 *
 * Используется один раз в GameDrawer::redraw_console()
 *
 */
 ...
 * Player::get_extra_specifications(Pawn&, int), Enemy::get_extra_specifications(Pawn&, int),
 * Player::apply_damage(const Pawn&, int, int) и Enemy::apply_damage(const Pawn&, int, int)
 *
 */
