...
class Player : public Pawn {
    ...
    /// @brief Использованные эффекты (есть проверка этого массива на повторяемость для единовременных эффектов) @see Player::get_extra_specifications(const Pawn&, int)
