 ...
 *        ударом (настраиваются в константе
 * @see Enemies::EFFECT_RELATION
 * ) c учётом их частоты вызывания.
 *
 ...
 *  также есть усложнённый аналог для игрока:
 ...
 *        определённых в константе
 *        @see Enemies::POSTEFFECT_RELATION
 *
 ...
 *
 * @return Enemy::Types - тег выбранного персонажа
 *
 */
 ...
 * @see Enemy
 * со случайным типом. Сразу устанавливаются параметры при помощи метода
 ...
 *        с наградным оружием) при помощи констант:
 *        @see INITIAL_HEALTHES
 *        ,
 *        @see SPECIFICATIONS
 *        ,
 *        @see REWARDS
 ...
 * #### Example:
 *
 * Используется только в конструкторе по умолчанию:
 * @see Enemy::Enemy()
 */
